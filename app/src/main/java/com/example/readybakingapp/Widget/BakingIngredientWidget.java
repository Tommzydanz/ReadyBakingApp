package com.example.readybakingapp.Widget;
...
import static com.example.readybakingapp.IngredientsActivity.widgetText;
...
public class BakingIngredientWidget extends AppWidgetProvider {
    ...
    public void onEnabled(Context context) {
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.baking_ingredient_widget);
        views.setTextViewText(R.id.appwidget_text, "Check List Here");
